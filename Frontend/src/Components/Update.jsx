function Update(){
 ...
 xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-card-text" viewBox="0 0 16 16">
  ...
  <br/>
  <button type="submit" class="btn btn-warning px-5">Düzenle</button>
</form>
</div>
        </>
    )
